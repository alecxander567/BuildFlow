    ...
    <div className="hidden md:flex items-center justify-between gap-3 border-b border-[#EDE8E2] bg-white px-8 py-4">
      <div className="relative min-w-0 flex-1 md:max-w-sm">
        ...
        <input
          ...
          className="w-full rounded-xl border border-[#E8E4DE] bg-[#F9F7F4] py-2.5 pl-9 pr-4 text-sm text-[#1A1916] placeholder:text-[#B0ADA7] outline-none transition-colors focus:border-[#E8610A] focus:bg-white"
        />
        <kbd className="pointer-events-none absolute right-3 top-1/2 -translate-y-1/2 hidden rounded-md border border-[#E8E4DE] bg-white px-1.5 py-0.5 text-[10px] font-medium text-[#B0ADA7] sm:block">
          ⌘K
        </kbd>
      </div>
