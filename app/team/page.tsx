...
import { useProjects, type Project } from "@/app/hooks/useProject";
import { useAlert, AlertContainer } from "@/app/components/Alert";
import Sidebar from "@/app/components/Sidebar";
import TopBar from "@/app/components/Topbar";
import { useTeam, type TeamMember, type AppUser } from "@/app/hooks/useTeam";
...
function EmptyState({
  ...
  return (
    <div className="flex flex-col items-center justify-center py-14 px-6 text-center">
      ...
      <p
        className="mb-4 max-w-xs text-xs leading-relaxed"
    ...
    <div
      ...
      {canRemove && (
        <button
          ...
          disabled={removing}
          className="ml-3 flex-shrink-0 text-xs font-medium px-3 py-1.5 rounded-lg border transition-all disabled:opacity-50"
          style={{
            color: "var(--error)",
    ...
    <div
      ...
      <div className="flex items-center gap-3 min-w-0">
        ...
        <div className="min-w-0">
          ...
          {typeof availableUser.bio === "string" && availableUser.bio ? (
            <p
      ...
      <button
        ...
        disabled={adding}
        className="ml-3 flex-shrink-0 flex items-center gap-1.5 text-xs font-semibold text-white px-3 py-1.5 rounded-lg transition-all disabled:opacity-50"
        ...
        <div className="flex -space-x-2">
          {preview.map((member) => (
            <div
              ...
              className="w-7 h-7 rounded-full bg-gradient-to-br from-[#E8610A] to-[#F5A623] border-2 flex items-center justify-center text-white text-[10px] font-bold"
...
export default function TeamPage() {
  ...
  const handleAddMember = async (member: AppUser) => {
            ...
            <div className="mx-auto max-w-6xl flex flex-col gap-5 md:gap-7">
              ...
              <div className="flex flex-col sm:flex-row sm:items-center gap-3">
                ...
                <div className="relative w-full sm:w-80">
                  <select
                    ...
                    className="w-full appearance-none text-sm rounded-xl px-4 py-2.5 pr-9 focus:outline-none transition-all cursor-pointer border"
                    style={{
                      backgroundColor: "var(--bg-card)",
                      borderColor: "var(--border)",
              ...
              {selectedProject ?
                <div
                  ...
                  {ownerOfSelected && (
                    <div
                      className="flex gap-6 px-6 pt-4 border-b"
                      ...
                      <>
                        <div className="flex items-center justify-between mb-4">
                          ...
                          {ownerOfSelected && (
                            <button
                              onClick={() => setActiveTab("available")}
                              className="flex items-center gap-1.5 text-xs font-semibold text-white px-3 py-2 rounded-xl transition-all"
                              style={{ backgroundColor: "var(--accent)" }}
                              onMouseEnter={(e) => {
                        ...
                        <div className="mb-4">
                          ...
                          <div className="relative">
                            ...
                            <input
                              ...
                              className="w-full pl-9 pr-4 py-2.5 rounded-xl text-sm focus:outline-none border transition-all"
                              style={{
                                backgroundColor: "var(--bg-base)",
                                borderColor: "var(--border)",
                                color: "var(--text-primary)",
